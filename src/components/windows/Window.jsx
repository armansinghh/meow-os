  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`w-full h-full rounded-xl flex flex-col overflow-hidden border transition-all duration-200 bg-white ${isFocused
      ...
      >
        <div
          className={`window-drag-handle relative flex items-center justify-between px-4 h-12 transition-colors duration-200 z-50 ${isFocused ? "bg-slate-50/90" : "bg-slate-50/50"
        ...
        >
          ...
          <div className="absolute left-1/2 -translate-x-1/2 flex items-center pointer-events-none">
            <span className={`text-sm font-semibold tracking-wide transition-colors ${isFocused ? "text-slate-700" : "text-slate-400"
              }`}>
              {title}
            </span>
          </div>
