"use client"
import { FaCat, FaPaw } from "react-icons/fa6"
...
export default function PawMenu({ onClose }) {
  ...
  return (
    <div className="absolute bottom-14 left-4 w-56 bg-black/60 backdrop-blur-xl border border-white/20 rounded-2xl p-4 flex flex-col gap-4 text-white shadow-2xl">
