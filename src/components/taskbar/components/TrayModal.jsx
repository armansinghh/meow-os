...
export default function TrayModal({ onClose }) {
  return (
    <motion.div
      ...
      className="absolute bottom-14 right-4 w-64 bg-black/60 backdrop-blur-xl border border-white/20 rounded-2xl p-4 flex flex-col gap-4 text-white shadow-2xl"
    >
      {/* Header */}
